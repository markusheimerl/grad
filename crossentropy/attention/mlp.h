...
typedef struct {
    ...
    float** ff_residual_layers; // For residual connection: r = X + attn_output.
    ...
    // Final predictions and error.
    float* predictions; // The final output (shape: [batch_size x (input_dim * embedding_dim)]).
